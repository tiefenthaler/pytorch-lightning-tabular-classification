...
def histplot_distribution_numeric_features(
    df: pd.DataFrame = None, hue: Optional[str] = None, figsize_width: float = 20
) -> None:
...
def boxplot_distribution_numeric_features(
    df: pd.DataFrame = None, hue: Optional[str] = None, figsize_width: float = 20
) -> None:
...
def plot_distribution_numeric_features(
    ...
    for idx, col in enumerate(cols_numeric_feat):
        ...
        sns.histplot(
            data=df_numeric_feat,
            x=col,
            hue=hue,
            bins=len(df_numeric_feat),
            stat="density",
            element="step",
            fill=False,
            cumulative=True,
